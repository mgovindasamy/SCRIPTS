...
REM ##  that are associated with a table or from other tables foreign keys that reference
REM ##  that table.
REM ##  Either run this script logged on to SYS or SYSTEM or GRANT SELECT on the DICTIONARY
-- ================================================
--
...
SET ECHO OFF FEED ON HEAD ON ARRAYSIZE 1  LONG 5000 VERIFY OFF 
SET LINE 190 PAGES 1234 serverout on 
...
COLUMN PCT_INCREASE FORMAT 9999999999999 heading "%|Incr"
COLUMN INITIAL_EXTENT FORMAT 999999999 heading "Init|Extent"
COLUMN NEXT_EXTENT FORMAT    9999999999999 heading "Next|Extent"
COLUMN MAX_EXTENTS FORMAT 9999999999999 heading "Max|Ext"
COLUMN AVG_ROW_LEN FORMAT 9999999999999 heading "Avg|Row|Len"
...
prompt skipped due to performance issue
...
COLUMN COLUMN_NAME FORMAT A30 heading "Column Name"
COLUMN COLUMN_POSITION FORMAT 9999 heading "Pos"
COLUMN PCT_FREE FORMAT 999999999 heading "%|Free"
COLUMN PCT_INCREASE FORMAT 999999999 heading "%|Incr"
COLUMN INITIAL_EXTENT FORMAT 999999999 heading "Init|Extent"
COLUMN NEXT_EXTENT FORMAT 999999999 heading "Next|Extent"
COLUMN MAX_EXTENTS FORMAT 999999999 heading "Max|Ext"
...
PROMPT
PROMPT #######################
PROMPT Show all the GRANTS made on this table and its columns.
PROMPT #######################
